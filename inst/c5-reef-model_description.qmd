...
params@species_params %>%
    ...
    mutate(rep_species = paste0("*", rep_species, "*")) %>%
    select(func_group,rep_species,biomass_observed, biomass_cutoff) %>%
    kable(row.names = FALSE,
          col.names = c("Functional group","Representative Species",
...
Many coral reef fisheries have limited regulation and takes are typically under-reported. For this general example, we use a knife-edge selectivity function which defines a minimum fishing size above which all sizes are 
selected.
