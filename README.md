...
Beese C. M., Delius G., Mumby P. J., Rogers A. (2026). _MizerReef: an R package to create multi-species size spectrum models for structurally complex habitats_. R package version 2.1.0, <https://github.com/cmbeese/mizerReef>.
